...
export default class PedidoExtras {
    ...
    static get() {
        return [
            ...
            new ModeloPedido('15x21 Irmãos com borda branca', 13),
            new ModeloPedido('15x21 Arquivo digital (aluno)', 15),
            new ModeloPedido('15x21 Arquivo digital (irmãos)', 15),
            new ModeloPedido('15x21 Diagramado Turma', 13),
            new ModeloPedido('10x15 Aluno com borda branca', 9),
            new ModeloPedido('10x15 Irmãos com borda branca', 9),
